...
- algorithm: FedAvg, FedAvgM, FedProx, SCAFFOLD, MOON builder tạo được Flower strategy
- training: FedProx proximal term, SCAFFOLD control delta, MOON contrastive metrics
