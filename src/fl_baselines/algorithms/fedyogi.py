...
class CheckpointingFedYogi(CheckpointingStrategyMixin, FedYogi):
    pass


class FedYogiBuilder:
    name = "fedyogi"
    ...
    def build_strategy(
        ...
        return CheckpointingFedYogi(
            ...
            eta=config.fedyogi_eta,
            eta_l=config.fedyogi_eta_l,
            beta_1=config.fedyogi_beta_1,
            beta_2=config.fedyogi_beta_2,
            tau=config.fedyogi_tau,
