...
class CheckpointingFedAdam(CheckpointingStrategyMixin, FedAdam):
    pass


class FedAdamBuilder:
    name = "fedadam"
    ...
    def build_strategy(
        ...
        return CheckpointingFedAdam(
            ...
            eta=config.fedadam_eta,
            eta_l=config.fedadam_eta_l,
            beta_1=config.fedadam_beta_1,
            beta_2=config.fedadam_beta_2,
