    ...
    def _fit_config(self, config: ExperimentConfig):
        def fn(server_round: int) -> dict[str, bool | bytes | float | int | str]:
            return {
                ...
                "fedala_eta": config.fedala_eta,
                "fedala_rand_percent": config.fedala_rand_percent,
                "fedala_layer_count": config.fedala_layer_count,
                "fedala_threshold": config.fedala_threshold,
                "fedala_num_pre_loss": config.fedala_num_pre_loss,
                "fedala_start_max_steps": config.fedala_start_max_steps,
            }
