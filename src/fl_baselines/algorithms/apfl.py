    ...
    def _fit_config(self, config: ExperimentConfig):
        def fn(server_round: int) -> dict[str, bool | bytes | float | int | str]:
            return {
                ...
                "apfl_alpha": config.apfl_alpha,
                "apfl_personal_learning_rate": config.apfl_personal_learning_rate,
                "apfl_adaptive_alpha": config.apfl_adaptive_alpha,
                "apfl_alpha_learning_rate": config.apfl_alpha_learning_rate,
            }
