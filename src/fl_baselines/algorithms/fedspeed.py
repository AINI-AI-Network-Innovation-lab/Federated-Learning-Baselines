    ...
    def _fit_config(self, config: ExperimentConfig):
        def fn(server_round: int) -> dict[str, bool | bytes | float | int | str]:
            return {
                ...
                "fedspeed_lambda": config.fedspeed_lambda,
                "fedspeed_alpha": config.fedspeed_alpha,
                "fedspeed_rho": config.fedspeed_rho,
            }
