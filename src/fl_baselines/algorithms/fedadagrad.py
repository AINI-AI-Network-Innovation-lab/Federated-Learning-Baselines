...
class CheckpointingFedAdagrad(CheckpointingStrategyMixin, FedAdagrad):
    pass


class FedAdagradBuilder:
    name = "fedadagrad"
    ...
    def build_strategy(
        ...
        return CheckpointingFedAdagrad(
            ...
            eta=config.fedadagrad_eta,
            eta_l=config.fedadagrad_eta_l,
            tau=config.fedadagrad_tau,
